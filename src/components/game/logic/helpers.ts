...
export const getCellNeighbours = (cells: Cell[], boardWidth: number, cellNum: number, radius: number = 1): Cell[] => {
    let mask: boardMask = []
...
const getMaskedCells = (cells: Cell[], boardWidth: number, cellNum: number, mask: boardMask): Cell[] => {
    let maskValues = []
